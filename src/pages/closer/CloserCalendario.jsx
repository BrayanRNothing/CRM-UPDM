...
import { Calendar as CalendarIcon, Clock, User, Phone, CheckCircle2, XCircle, MapPin, ChevronLeft, ChevronRight } from 'lucide-react';
...
const CloserCalendario = () => {
    ...
    const [reuniones] = useState(MOCK_REUNIONES);
